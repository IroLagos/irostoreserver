...
cloudinary.config({
	...
	const create = async (req, res) => {
		try {
			...
			const {title, heading, availability, price, discount, description, color, size, imageUrl } = req.body;
	...
	const update = async (req, res) => {
		try {
			const { title, heading, availability, price, discount, description, color, size, categoryId } = req.body;
